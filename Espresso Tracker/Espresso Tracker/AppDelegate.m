...
//    }
    ...
    //Example medium date style: “Nov 23, 1937”
    NSDate *pastDate = [formatter dateFromString:@"Oct 16, 2013"];
...
//#################################################################################
    //            THIS CODE SAVES THE DATA AND NEEDS TO BE READDED!!!
    //            It is convenient to leave it commented out so that
    //            we don't have to reset the Simulator state each time
    //            we run it for debugging purposes.
    
//      NSError *error;
#warning DataStore saving is turned off
//    if (![context save:&error]) {
//        NSLog(@"Whoops, couldn't save: %@", [error localizedDescription]);
//    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Espresso_Tracker" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Espresso_Tracker.sqlite"];
